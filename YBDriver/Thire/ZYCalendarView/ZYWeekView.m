...
//        self.layer.borderColor = [UIColor colorWithHexString:@"#f1f3f4" andAlpha:1.0].CGColor;
...
- (void)setDate:(NSDate *)date {
    ...
    for (int i = 0; i < 7; i++) {
        ZYDayView *dayView = [[ZYDayView alloc] initWithFrame:CGRectMake(dayViewWidth * i, 2, dayViewWidth, dayViewHeight)];
